...
//        if(viewModel.hasActiveInternetConnection(requireContext())){
//            viewModel.showsLiveData.observe(viewLifecycleOwner) { showList ->
//                showsAdapter.addAllItems(showList)
//            }
            viewModel.fetchShowsFromApi()
//        }
//        else if (!viewModel.hasActiveInternetConnection(requireContext()) && viewModel.fetchShowsFromDatabase().value != null){
